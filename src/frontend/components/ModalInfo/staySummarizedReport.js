...
import staySummarizedReportTable from "../tables/staySummarizedReportTable.js"
...
function staysSummarizedReport({ filter, listed, staysSummarizedReportBuild}){
    ...
    staySummarizedReportTable(tablediv, listed)
    ...
    btnAdd.addEventListener("click", () => {
        ...
        console.log(newList)
        staysSummarizedReportBuild(pathPDF, data, newList)
    })
...
export default staysSummarizedReport